...
public class Mover_Lixeira : MonoBehaviour
{
    ...
    //------ Variáveis Publicas -------
    //Cria uma variável publica que receberá a velocidade de aceleração 
    public float velocidade;

    //------ Variáveis Privadas --------
    //Cria uma variável que receberá o deslocamento no eixo horizobtal (X)
    float deslocamentoHorizontal;

    //Cria uma variável do tipo Vector 2D para deslocar o objeto
    Vector2 deslocamento = Vector2.zero;

    //Cria uma variável Rigidbody2D para deslocar o objeto pelo seu Rigidbody
    Rigidbody2D rbLixeira;

    //Essa variável será usada para chamar o Script Rotacionar_Bolinhas
    ...
    {
        //Inicializa a variável pontosGanhos recebendo todas as 
